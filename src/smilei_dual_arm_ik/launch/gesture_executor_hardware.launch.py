#!/usr/bin/env python3
"""
Launch file for Gesture Executor Hardware (Real BEAR Motors)

Launches the gesture executor node with hardware control
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    usb_ports = LaunchConfiguration('usb_ports')
    ...
    # Gesture Executor Hardware Node
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='USB ports for BEAR motors'
        ),
        DeclareLaunchArgument(
            'baudrate',
            default_value='8000000',
            description='Baudrate for motor communication'
        ),
