...
def launch_setup(context, *args, **kwargs):
    ...
    traj_params = trajectory_config.get('trajectory_params', {})
    interpolation_method = traj_params.get('interpolation_method', 'cubic')
    steps_per_segment = traj_params.get('steps_per_segment', 50)
    execution_rate = traj_params.get('execution_rate', 10.0)
